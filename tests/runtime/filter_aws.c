...
void flb_test_aws_ec2_tags_present() {
    ...
    struct flb_aws_client_mock_request_chain *request_chain = FLB_AWS_CLIENT_MOCK(
        response(
    ...
    struct flb_aws_client_generator *client_generator = flb_aws_client_get_mock_generator();
    struct flb_filter_aws_init_options *ops = flb_calloc(1, sizeof(struct flb_filter_aws_init_options));
    flb_sds_t name = flb_sds_create_size(100);
